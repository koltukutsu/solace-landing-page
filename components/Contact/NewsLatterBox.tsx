...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp shadow-three dark:bg-gray-dark relative z-10 rounded-md bg-white p-8 sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Bizden haber almak için bültenimize kaydolun
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Solace olarak, Akıllı Ev Sistemleri ve Akıllı Dünya hakkında araştırmalar yapıyor, analizler paylaşıyoruz. Haberdar olmak için bültenimize kaydolun.
      </p>
      <div>
        <input
          type="text"
        ...
        <input
          type="submit"
          value="Takip Et!"
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-md bg-primary px-9 py-4 text-base font-medium text-white duration-300 hover:bg-primary/90"
        />
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#0E76A8" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
