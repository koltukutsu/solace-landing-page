const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className="wow fadeInUp shadow-three dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark relative z-10 rounded-md bg-white px-8 py-10 hover:shadow-one"
        data-wow-delay=".1s"
      >
        <div className="flex items-center justify-between">
          ...
          <h4 className="mb-2 text-xl font-bold  dark:text-body-color text-body-color">
            {duration}
          </h4>
        </div>
