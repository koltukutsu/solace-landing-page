    ...
    <div className="container">
      ...
      <div className="grid grid-cols-2 gap-8 md:grid-cols-2 lg:grid-cols-4">
        {teamData.map((member) => (
            ...
            <div className="flex flex-col items-center pb-10">
              ...
              <a href={member.linkedin} target="_blank">
                <div className="flex items-center">
                  <FaLinkedin className="hover:text-primary-dark mr-2 text-3xl text-primary duration-300 lg:text-3xl" />
          ...
          // <div
          //   key={member.id}
          //   classNameName="relative z-10 rounded-sm bg-white p-6 shadow-two dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark"
          // >
          //   <a
